...
class CustomEnv(gym.Env):
    ...
    def step(self, action):
        ...
        index, operation, table = self.interpret_action(action)
        ...
        if operation == 'increment':
            selected_table[index] += 5
            #print(f"incremented {index} to {selected_table[index]} on table {table}")
        else:  # operation == 'decrement'
            selected_table[index] -= 5
            #print(f"decremented {index} to {selected_table[index]} on table {table}")
